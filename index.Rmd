...
---
#### Distribución puntajes <FONT COLOR="red">aspirantes vs admitidos</FONT> - sedes UNAL

.panelset[

.panel[.panel-name[Bogotá]

```{r, echo=FALSE, message=FALSE, warning=FALSE, fig.align='left', ,out.height='415'}
hc_size(Asp_Adm_Bog, height= 395)
```
...
.panel[.panel-name[Medellín]

```{r, echo=FALSE, message=FALSE, warning=FALSE, fig.align='left', ,out.height='415'}
hc_size(Asp_Adm_Med, height= 395)
```
...
.panel[.panel-name[Manizales]

```{r, echo=FALSE, message=FALSE, warning=FALSE, fig.align='left', ,out.height='415'}
hc_size(Asp_Adm_Man, height= 395)
```
...
.panel[.panel-name[Palmira]

```{r, echo=FALSE, message=FALSE, warning=FALSE, fig.align='left', ,out.height='415'}
hc_size(Asp_Adm_Pal, height= 395)
```
...
.panel[.panel-name[De La Paz]

```{r, echo=FALSE, message=FALSE, warning=FALSE, fig.align='left', ,out.height='415'}
hc_size(Asp_Adm_Paz, height= 395)
```
...
.panel[.panel-name[Orinoquía]

```{r, echo=FALSE, message=FALSE, warning=FALSE, fig.align='left', ,out.height='415'}
hc_size(Asp_Adm_Orq, height= 395)
```
...
.panel[.panel-name[Amazonía]

```{r, echo=FALSE, message=FALSE, warning=FALSE, fig.align='left', ,out.height='415'}
hc_size(Asp_Adm_Amz, height= 395)
```
...
.panel[.panel-name[Caribe]

```{r, echo=FALSE, message=FALSE, warning=FALSE, fig.align='left', ,out.height='415'}
hc_size(Asp_Adm_Car, height= 395)
```
...
.panel[.panel-name[Tumaco]

```{r, echo=FALSE, message=FALSE, warning=FALSE, fig.align='left', ,out.height='415'}
hc_size(Asp_Adm_Tum, height= 395)
```
